...
import { Search, Bell, User, Camera, CreditCard, Sparkles, Calendar, LogOut, Settings, ChevronDown } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    { id: 'discover', label: 'DISCOVER', icon: Search, path: '/dashboard' },
    { id: 'payment', label: 'PAYMENT', icon: CreditCard, path: '/payment' },
    { id: 'showcase', label: 'SHOWCASE', icon: Sparkles, path: '/showcase' },
