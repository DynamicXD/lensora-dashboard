...
import signinImg from "../../../images/usersignup.jpg";
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-sm border border-gray-100">
          ...
          <p className="text-sm text-center text-gray-600">
            ...
            <Link className="text-violet-600 font-medium hover:text-violet-700 transition-colors" to="/user/login">
              Log In
            </Link>
          </p>
        </div>
      ...
      <div className="hidden md:block flex-1 relative">
        <img src={signinImg} alt="Sign up visual" className="object-cover w-full" />
