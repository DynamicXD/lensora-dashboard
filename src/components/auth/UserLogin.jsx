...
import loginImg from "../../../images/userlogin.jpg";
...
function UserLogin() {
  ...
  const validateForm = () => {
    ...
    // Password validation (changed from 8 to 6 characters to match your API)
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <motion.div variants={itemVariants} className="pt-2">
                  <motion.button
                    type="submit"
                    className={`w-full py-3.5 px-6 rounded-xl font-semibold text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 transition-all duration-200 flex items-center justify-center ${isSubmitting
